...
int main() {
    ...
    ReadParseData parser;
    parser.readFromFile("data/closeCylinder.fem");

    std::cout << "\nBefore alignment:" << std::endl;
    parser.printCoordinateRanges();

    parser.estimateAndAlignAxis();

    std::cout << "\nAfter alignment:" << std::endl;
    parser.printCoordinateRanges();
    ...
    //try {
    //    readParseData.readFromFile("data/closeCylinder.fem");
    //}
